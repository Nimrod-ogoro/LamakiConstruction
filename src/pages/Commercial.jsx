    ...
    <div className="commercial-d" style={{ fontFamily: "Segoe UI, Tahoma, Geneva, Verdana, sans-serif", color: "#222", background: "#f9fafc", lineHeight: "1.7" }}>
      ...
      <section className="process-d" style={{ padding: "70px 20px", maxWidth: "1100px", margin: "auto", textAlign: "center" }}>
        ...
        <ol style={{ listStyle: "none", padding: "0", maxWidth: "700px", margin: "0 auto" }}>
          <li style={{ background: "#fff", padding: "18px 24px", margin: "15px 0", borderLeft: "6px solid #0077b6", borderRadius: "6px", textAlign: "left", fontWeight: "500", color: "#333", boxShadow: "0 4px 12px rgba(0, 64, 128, 0.1)" }}>1. Site Evaluation</li>
          <li style={{ background: "#fff", padding: "18px 24px", margin: "15px 0", borderLeft: "6px solid #0077b6", borderRadius: "6px", textAlign: "left", fontWeight: "500", color: "#333", boxShadow: "0 4px 12px rgba(0, 64, 128, 0.1)" }}>2. Design & Architecture</li>
          <li style={{ background: "#fff", padding: "18px 24px", margin: "15px 0", borderLeft: "6px solid #0077b6", borderRadius: "6px", textAlign: "left", fontWeight: "500", color: "#333", boxShadow: "0 4px 12px rgba(0, 64, 128, 0.1)" }}>3. Construction & Fit-out</li>
          <li style={{ background: "#fff", padding: "18px 24px", margin: "15px 0", borderLeft: "6px solid #0077b6", borderRadius: "6px", textAlign: "left", fontWeight: "500", color: "#333", boxShadow: "0 4px 12px rgba(0, 64, 128, 0.1)" }}>4. Compliance & Handover</li>
        </ol>
      </section>
      ...
      <section className="guarantees-d" style={{ padding: "70px 20px", maxWidth: "1100px", margin: "auto", textAlign: "center" }}>
        ...
        <ul style={{ listStyle: "none", padding: "0", maxWidth: "600px", margin: "auto", textAlign: "left" }}>
          <li style={{ background: "#fff", margin: "12px 0", padding: "14px 18px", borderRadius: "8px", boxShadow: "0 3px 10px rgba(0, 64, 128, 0.12)", display: "flex", alignItems: "center", gap: "10px", fontWeight: "500", color: "#004080" }}><CheckCircle size={20} /> Cost-Effective Solutions</li>
          <li style={{ background: "#fff", margin: "12px 0", padding: "14px 18px", borderRadius: "8px", boxShadow: "0 3px 10px rgba(0, 64, 128, 0.12)", display: "flex", alignItems: "center", gap: "10px", fontWeight: "500", color: "#004080" }}><CheckCircle size={20} /> Safety Compliance</li>
          <li style={{ background: "#fff", margin: "12px 0", padding: "14px 18px", borderRadius: "8px", boxShadow: "0 3px 10px rgba(0, 64, 128, 0.12)", display: "flex", alignItems: "center", gap: "10px", fontWeight: "500", color: "#004080" }}><CheckCircle size={20} /> Post-Project Support</li>
        </ul>
      </section>
      ...
      <section className="faq-d" style={{ padding: "70px 20px", maxWidth: "1100px", margin: "auto", textAlign: "center" }}>
        ...
        <div style={{ background: "#fff", margin: "16px auto", padding: "20px", borderRadius: "8px", maxWidth: "700px", boxShadow: "0 4px 14px rgba(0, 64, 128, 0.1)", textAlign: "left" }}>
          <h4 style={{ fontSize: "1.2rem", color: "#0077b6", marginBottom: "8px" }}>Do you handle large-scale commercial projects?</h4>
          <p>Yes, from single offices to large complexes.</p>
        </div>
        <div style={{ background: "#fff", margin: "16px auto", padding: "20px", borderRadius: "8px", maxWidth: "700px", boxShadow: "0 4px 14px rgba(0, 64, 128, 0.1)", textAlign: "left" }}>
          <h4 style={{ fontSize: "1.2rem", color: "#0077b6", marginBottom: "8px" }}>Do you offer maintenance after construction?</h4>
